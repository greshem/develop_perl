...
#2012_11_22_14:45:12   ÐÇÆÚËÄ   add by greshem
#fedora16 
...
set auto-load safe-path -- Set the list of directories from which it is safe to auto-load files
...
set python print-stack -- Enable or disable printing of Python stack dump on error
...
show auto-load safe-path -- Show the list of directories from which it is safe to auto-load files
...
show python print-stack -- Show whether Python stack will be printed on error
